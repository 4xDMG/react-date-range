...
class DayCell extends Component {
  ...
  getStateStyles() {
    ...
    const { isSelected, isInRange, isPassive, isStartEdge, isEndEdge, dayMoment, isToday, isSunday, isOneDay, isSaturday, isSpecialDay } = this.props;
    const { styles } = this;
    ...
    const saturdayStyle = isSaturday ? styles['DaySaturday'] : {};
    const oneDayStyle = isOneDay ? styles['DayOneDay'] : {};
  ...
  getClassNames(classes) {
    const { isSelected, isInRange, isPassive, isStartEdge, isEndEdge, isToday, isSunday, isSaturday, isOneDay, isSpecialDay } = this.props;
    ...
    return classnames({
      ...
      [classes.daySaturday]: isSaturday,
      [classes.dayOneDay]: isOneDay,
    });
